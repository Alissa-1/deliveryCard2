...
public class DataGenerator {
    ...
    public static String generateDate(int shift) {
        // логика для объявления переменной date и задания её значения, для генерации строки с датой
    ...
    public static String generateCity() {
        // логика для объявления переменной city и задания её значения, генерацию можно выполнить
    ...
    public static String generateName(String locale) {
        // логика для объявления переменной name и задания её значения, для генерации можно использовать Faker
    ...
    public static class Registration {
        ...
        public static UserInfo generateUser(String locale) {
            // Логика для создания пользователя user с использованием методов generateCity(locale),
